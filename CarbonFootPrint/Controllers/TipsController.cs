...
namespace CarbonFootPrint.Controllers
{
    public class TipsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Tips_Kind,Tips_Category,Image_Path,Tips")] Tip tip)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Tips_Kind,Tips_Category,Image_Path,Tips")] Tip tip)
        {
            if (ModelState.IsValid)
            {
